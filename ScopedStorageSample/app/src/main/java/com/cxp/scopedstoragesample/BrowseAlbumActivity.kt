...
import com.cxp.scopedstoragesample.databinding.ActivityBrowseAlbumBinding
import kotlin.concurrent.thread

class BrowseAlbumActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBrowseAlbumBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBrowseAlbumBinding.inflate(layoutInflater)
        ...
        binding.recyclerView.viewTreeObserver.addOnPreDrawListener(object :
            ...
            override fun onPreDraw(): Boolean {
                ...
                binding.recyclerView.layoutManager =
                    GridLayoutManager(this@BrowseAlbumActivity, columns)
